...
<img src="assets/graphics/icon-1024.svg" width="120" alt="CompProp Data Icon" />

# CompProp Data

### Property Intelligence. Instantly.

[![CI](https://github.com/Sianlk/comppropdata/actions/workflows/backend-ci.yml/badge.svg)](https://github.com/Sianlk/comppropdata/actions/workflows/backend-ci.yml)
[![Security Scan](https://github.com/Sianlk/comppropdata/actions/workflows/security-scan.yml/badge.svg)](https://github.com/Sianlk/comppropdata/actions/workflows/security-scan.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-iOS%20|%20Android-lightgrey.svg)](https://comppropdata.com)
[![FastAPI](https://img.shields.io/badge/backend-FastAPI-009688.svg)](https://fastapi.tiangolo.com)
[![React Native](https://img.shields.io/badge/mobile-React%20Native-61DAFB.svg)](https://reactnative.dev)

**real estate, AI, property data**

[Website](https://comppropdata.com) · [Privacy Policy](https://comppropdata.com/privacy) · [Support](https://comppropdata.com/support)
...
**CompProp Data** — Property Intelligence. Instantly.
...
- **AI-Powered Core** — Intelligent automation and recommendations tailored to real estate
...
```bash
# Clone the repo
git clone https://github.com/Sianlk/comppropdata.git
cd comppropdata
