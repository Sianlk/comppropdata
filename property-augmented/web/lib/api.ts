...
export const endpoints={
  health:'/health',status:'/api/v1/system/status',securityPosture:'/api/v1/system/security-posture',sources:'/api/v1/data/sources',site:'/api/v1/site/intelligence/full',
  analyse:'/api/v1/ai/analyse',deepResearch:'/api/v1/research/web-deep',policyLibrary:'/api/v1/policy/library',policySearch:'/api/v1/policy/search',agents:'/api/v1/agents',agentCommittee:'/api/v1/agents/committee',agentRuns:'/api/v1/agents/runs',evidenceClaims:'/api/v1/evidence/claims',appraisal:'/api/v1/calculators/appraisal',
