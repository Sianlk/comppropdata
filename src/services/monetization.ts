// Monetization & Subscription Engine — CompProp Data
...
export const PLANS: Record<Plan, PlanConfig> = {
  ...
  starter: {
    ...
    price_monthly: 9.99,
    price_annual: 7.99,
    sku_monthly: 'com.sianlk.comppropdata.starter.monthly',
    sku_annual: 'com.sianlk.comppropdata.starter.annual',
    features: [
      '100 AI requests/day',
  ...
  pro: {
    ...
    price_monthly: 29.99,
    price_annual: 19.99,
    sku_monthly: 'com.sianlk.comppropdata.pro.monthly',
    sku_annual: 'com.sianlk.comppropdata.pro.annual',
    features: [
  ...
  enterprise: {
    ...
    price_monthly: 99.99,
    price_annual: 79.99,
    sku_monthly: 'com.sianlk.comppropdata.enterprise.monthly',
    sku_annual: 'com.sianlk.comppropdata.enterprise.annual',
    features: [
