// AI Workforce Agent — CompProp Data
// Autonomous AI worker for real estate
...
// Specialised AI agents for real estate
const AGENT_PERSONAS = {
  analyst: {
    name: 'CompProp Data Analyst',
    role: `Expert real estate analyst with deep knowledge of property valuation, market analysis, investment scoring.`,
    capabilities: ["Market Intelligence", "AI Valuations", "Investment Score", "Comp Analysis", "Deal Pipeline"],
  },
  advisor: {
    name: 'CompProp Data Advisor',
    role: `Senior real estate advisor providing strategic recommendations.`,
    capabilities: ['Strategic planning', 'Risk assessment', 'Optimization'],
  },
  automator: {
    name: 'CompProp Data Automator',
    role: `Autonomous real estate task executor and workflow manager.`,
