...
const styles = StyleSheet.create({
  ...
  // Variants
  variant_primary:   { backgroundColor: '#10B981' },
  variant_secondary: { backgroundColor: '#34D39933' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#10B981' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#059669', borderWidth: 1, borderColor: '#34D399' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#059669' },
  label_outline:   { color: '#10B981' },
  label_ghost:     { color: '#10B981' },
