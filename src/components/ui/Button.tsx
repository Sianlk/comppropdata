// Button Component — CompProp Data
...
const s = StyleSheet.create({
  ...
  v_primary:   { backgroundColor: '#10B981' },
  v_secondary: { backgroundColor: '#34D39933' },
  v_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#10B981' },
  v_ghost:     { backgroundColor: 'transparent' },
  v_danger:    { backgroundColor: '#EF4444' },
  v_ai:        { backgroundColor: '#059669', borderWidth: 1, borderColor: '#34D399' },
  lbl:    { fontSize: 14, fontWeight: '600' },
  lv_primary:   { color: '#FFFFFF' },
  lv_secondary: { color: '#059669' },
  lv_outline:   { color: '#10B981' },
  lv_ghost:     { color: '#10B981' },
