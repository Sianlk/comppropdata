    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.tagline}>Property Intelligence. Instantly.</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Quick Access</Text>
        <View key="0" style={styles.featureCard}>
          <Text style={styles.featureText}>AI Comparable Search</Text>
        </View>
        <View key="1" style={styles.featureCard}>
          <Text style={styles.featureText}>Market Analytics</Text>
        </View>
        <View key="2" style={styles.featureCard}>
          <Text style={styles.featureText}>Property Reports</Text>
        </View>
        <View key="3" style={styles.featureCard}>
          <Text style={styles.featureText}>Valuation Tools</Text>
        </View>
        </View>
        {user && (
