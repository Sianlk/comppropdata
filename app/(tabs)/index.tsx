...
const QUICK_ACTIONS = [
        { id: '1', title: 'Market Intelligence', icon: 'sparkles-outline', color: Colors.primary },
        { id: '2', title: 'AI Valuations', icon: 'sparkles-outline', color: Colors.primary },
        { id: '3', title: 'Investment Score', icon: 'sparkles-outline', color: Colors.primary },
        { id: '4', title: 'Comp Analysis', icon: 'sparkles-outline', color: Colors.primary },
        { id: '5', title: 'Deal Pipeline', icon: 'sparkles-outline', color: Colors.primary },
];
...
export default function HomeScreen() {
  ...
  async function handleAIQuery() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'real estate');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>Commercial property intelligence platform</Text>
        </View>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — real estate</Text>
        </View>
        <TextInput
          style={styles.aiInput}
          placeholder={`Ask CompProp Data AI anything...`}
