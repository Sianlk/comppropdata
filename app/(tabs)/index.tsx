...
const ACTIONS = [
  { id: '1', title: 'Market Intelligence', icon: 'sparkles-outline' },
  { id: '2', title: 'AI Valuations', icon: 'sparkles-outline' },
  { id: '3', title: 'Investment Score', icon: 'sparkles-outline' },
  { id: '4', title: 'Comp Analysis', icon: 'sparkles-outline' },
  { id: '5', title: 'Deal Pipeline', icon: 'sparkles-outline' },
];
