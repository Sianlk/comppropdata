...
// CompProp Data — AI Agents & Workforce
...
export default function AIScreen() {
  ...
  const [taskType, setTaskType] = useState('Market Intelligence');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Domain: real estate</Text>

      <Card variant="ai" style={styles.card}>
        <Text style={styles.label}>Task Type</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tagRow}>
          {['Market Intelligence','AI Valuations','Investment Score','Comp Analysis','Deal Pipeline'].map((f) => (
            <TouchableOpacity
              key={f}
